...
from the [current release page](https://github.com/Natzirt-BK/RomRaider2/releases/tag/romraider2-1.1.2).
...
5. **RomRaider2 1.1.2** — install or update RomRaider2 separately.
...
- RomRaider2 1.1.2 does not enable ECU memory writing or flashing. EcuFlash remains
