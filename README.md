...
from the [current release page](https://github.com/Natzirt-BK/RomRaider2/releases/tag/romraider2-1.1.11).
...
5. **RomRaider2 1.1.11** — install or update RomRaider2 separately.
