...
archive_root=RomRaider2_ECU_Studio_1.1.8_Linux_x64
...
printf 'RomRaider2 ECU Studio 1.1.8\n' \
...
grep -F 'RomRaider2 1.1.8 installed' "$test_root/install.log" >/dev/null
