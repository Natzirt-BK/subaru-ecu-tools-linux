...
archive_root=RomRaider2_ECU_Studio_1.1.2_Linux_x64
...
printf 'RomRaider2 ECU Studio 1.1.2\n' \
...
grep -F 'RomRaider2 1.1.2 installed' "$test_root/install.log" >/dev/null
